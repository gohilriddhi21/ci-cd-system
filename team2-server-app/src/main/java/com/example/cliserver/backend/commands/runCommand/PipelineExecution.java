...
import static com.example.cliserver.controller.SseController.sendEvent;
...
public class PipelineExecution {
    ...
    /**
     * Flag to specify whether verbose logging should be shown to the user.
     */
     ...
     * @param useVerboseLogging flag to specify whether verbose logging should be shown to the user
     *                          for this pipeline execution
     */
    public PipelineExecution(String pipelineId, boolean useVerboseLogging) {
    ...
    public synchronized void log(String message) {
        ...
        // logs are always written to the log file but only outputted to the terminal if this
        // flag is set
