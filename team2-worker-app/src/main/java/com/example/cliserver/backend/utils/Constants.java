...
public class Constants {
    ...
    /**
     * The field name for the stage arrays in the MongoDB document.
     */
    ...
    /** Prefix for identifying remote Git branches. */
    public static final String REMOTE_BRANCH_PREFIX = "refs/remotes/origin/";
    /** Directory for locating artifacts generated locally before upload. */
    @SuppressFBWarnings("MS_SHOULD_BE_FINAL")
